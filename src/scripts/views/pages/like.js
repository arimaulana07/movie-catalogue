...
import FavoviteMovieSearchPresenter from './liked-movies/favorite-movie-search-presenter';
...
const Like = {
  ...
  async afterRender() {
    ...
    new FavoviteMovieSearchPresenter({ view, favoriteMovies: FavoriteMovieIdb });
  },
};
